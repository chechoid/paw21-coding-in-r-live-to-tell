...
You can work with any kind of data, and make any analysis that you ca02n imagine.
...
.pull-right[
Peter Thiel, with his analogy of going *from zero to one*, he points out that you're creating something new and disruptive, that solves a problem that no one had thought of before.
...
There's no secret recipe to learning to code, it takes time, practice, patience, and persistance. Nevertheless, these tips can be helpful:
